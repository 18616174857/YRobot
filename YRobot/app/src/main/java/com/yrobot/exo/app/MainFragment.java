...
import com.yrobot.exo.models.PeripheralModeViewModel;
...
public class MainFragment extends Fragment {
    ...
    // Log
    private final static String TAG = "yr-" + MainFragment.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        YrConstants.log(YrConstants.DEBUG, "MainFragment.onCreate");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        YrConstants.log(YrConstants.DEBUG, "MainFragment.onCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        YrConstants.log(YrConstants.DEBUG, "MainFragment.onViewCreated");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        YrConstants.log(YrConstants.DEBUG, "MainFragment.onActivityCreated");
...
//                mNavigationView.setSelectedItemId(R.id.navigation_central);
    ...
    private boolean selectFragment(@NonNull MenuItem item) {
        ...
        YrConstants.log(YrConstants.DEBUG, "MainFragment.selectFragment [" + item.getItemId() + "]");
...
//                    selectedFragment = ScannerFragmentMinimal.newInstance();
//                    break;
...
//        if (getCurrentFragment() instanceof ScannerFragmentMinimal) {
//            ((ScannerFragmentMinimal) getCurrentFragment()).startScanning();
//        }
//    }
//
...
//        // Send the message to the peripheral mode fragment, or ignore it if is not selected
//        if (getCurrentFragment() instanceof ScannerFragmentMinimal) {
//            ((ScannerFragmentMinimal) getCurrentFragment()).disconnectAllPeripherals();
//        }
//    }
...
//            mListener.startUserStatusFragment();
