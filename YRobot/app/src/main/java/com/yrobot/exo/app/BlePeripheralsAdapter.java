...
import static com.yrobot.exo.ble.central.BleScanner.kDeviceType_Beacon;
import static com.yrobot.exo.ble.central.BleScanner.kDeviceType_Uart;
import static com.yrobot.exo.ble.central.BleScanner.kDeviceType_UriBeacon;
...
//            result.dispatchUpdatesTo((ListUpdateCallback)this);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.connectButton.setOnClickListener(view -> {
            ...
            YrConstants.log(YrConstants.SCANNER, "BlePeripheralsAdapter Connect Pressed");
