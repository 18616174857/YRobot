package com.yrobot.exo.ble.central;
...
//    private static final int kUartTxMaxBytes = 40;
    private static final int kUartTxMaxBytes = 128 + 6;
...
//            Log.v(TAG, "yr-uart tx 1 [" + uartRxHandler + "]");
//            BlePeripheral.NotifyHandler notifyHandler = uartRxHandler == null ? null : status -> {
            BlePeripheral.NotifyHandler notifyHandler = status -> {
//                Log.v(TAG, "yr-uart tx 1 [" + status + "] [" + BluetoothGatt.GATT_SUCCESS + "]");
                UartRxHandler handler = weakUartRxHandler.get();
                if (handler != null) {
//                    Log.v(TAG, "yr-uart tx 2 [" + status + "] [" + BluetoothGatt.GATT_SUCCESS + "]");
...
//                    Log.d(TAG, "uartSend offset [" + finalOffset + "] [" + data.length + "] [" + completionHandler + "]");
                    completionHandler.completion(status);
                }
            });
