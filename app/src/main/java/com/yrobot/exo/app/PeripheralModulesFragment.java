...
public class PeripheralModulesFragment extends ConnectedPeripheralFragment {
    ...
    private final static int MODULE_YR = 9;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        YrConstants.log(YrConstants.DEBUG, TAG + ".onViewCreated");
    ...
    public void onModuleSelected(int moduleId) {
        ...
        YrConstants.log(YrConstants.SCANNER, TAG + "onModuleSelected [" + singlePeripheralIdentifier + "]");
        ...
        switch (moduleId) {
            ...
            case MODULE_YR:
                fragment = ControlFragment.newInstance(singlePeripheralIdentifier);
                break;
    ...
    private static class ModulesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private int[] getMenuItems() {
            if (mConnectionMode == CONNECTIONMODE_MULTIPLEPERIPHERAL) {
                ...
                if (hasUart && hasDfu) {
                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_PLOTTER, MODULE_YR, MODULE_PINIO, MODULE_CONTROLLER, MODULE_NEOPIXEL, /*MODULE_CALIBRATION,*/ MODULE_THERMALCAMERA, MODULE_DFU};
                } else if (hasUart) {
                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_PLOTTER, MODULE_YR, MODULE_PINIO, MODULE_CONTROLLER, /*MODULE_CALIBRATION, */MODULE_THERMALCAMERA};
                } else if (hasDfu) {
